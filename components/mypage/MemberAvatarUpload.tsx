...
export default function MemberAvatarUpload({ name, defaultValue }: Props) {
    ...
    <div>
      ...
      {url ? (
        <div className="relative w-24 h-24 rounded-full overflow-hidden border border-border group">
          <img src={url} alt="프로필 사진 미리보기" className="w-full h-full object-cover" />
          <button
            type="button"
        ...
        <label
          htmlFor="member-avatar-input"
          className={`flex flex-col items-center justify-center w-24 h-24 rounded-full border-2 border-dashed border-border cursor-pointer hover:border-primary hover:bg-primary/5 transition-colors${
